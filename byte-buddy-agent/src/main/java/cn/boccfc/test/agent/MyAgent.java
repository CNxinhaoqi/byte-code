package cn.boccfc.test.agent;

import cn.boccfc.test.intercept.MethodCostTime;
...
public class MyAgent {
    ...
    public static void premain(String agentArgs, Instrumentation inst) {
        ...
        AgentBuilder.Listener listener = new AgentBuilder.Listener() {
            @Override
            public void onDiscovery(String s, ClassLoader classLoader,
        ...
        new AgentBuilder
                .Default()
                //指定需要拦截的类
                .type(ElementMatchers.nameStartsWith("cn.boccfc.test"))
